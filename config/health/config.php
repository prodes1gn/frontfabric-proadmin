...
//            'NginxServer',
    ...
    'notifications' => [
        ...
        'from' => [
            ...
            'address' => config('cms.system_email'),
            'icon_emoji' => ':anger:',
        ],
        'scheduler' => [
            'enabled' => true,
            'frequency' => 'everyMinute', // most methods on -- https://laravel.com/docs/8.x/scheduling#schedule-frequency-options
        ],
        'users' => [
            'model' => App\Models\User::class,
            'emails' => [config('cms.system_email')],
        ],
    ...
    'routes' => [
        'prefix' => $route_prefix = '/' . config('cms.admin_panel_url') . '/core/health',
        ...
        'list' => [
            [
                ...
                'middleware' => [
                    'web', 'auth', 'blockIP', 'activityLog', 'banned', 'admin_locale', 'can:health_access',
                ],
            ],
            [
