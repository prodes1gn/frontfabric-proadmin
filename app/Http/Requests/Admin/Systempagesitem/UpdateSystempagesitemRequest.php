...
class UpdateSystempagesitemRequest extends FormRequest {
    ...
    public function rules() {
        return [
            'name' => [
                'between:3,150',
                'required',
                Rule::unique('systempagesitems_translations')->where('locale', $this->lang)->ignore($this->systempagesitem->id, 'systempagesitem_id'),
            ],
