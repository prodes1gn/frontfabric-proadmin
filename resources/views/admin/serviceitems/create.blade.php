        ...
        <div class="card-body pb-5 row">
            <div class="col-lg-8">
                ...
                <div class="form-group {{ $errors->has('hometext') ? 'has-error' : '' }}">
                    ...
                    <input class="form-control form-control-solid maxlength" maxlength="255" type="text" name="hometext" value="{{ old('hometext', '') }}" placeholder="{{ trans('global.enter') }} {{ trans('cruds.hometext') }}">
            ...
            <div class="col-lg-4">
                ...
                <div class="form-group {{ $errors->has('servicepointdropdown') ? 'has-error' : '' }}">
                    ...
                    <select class="form-control form-control-solid select2 select2_multiselect" name="servicepointdropdown[]" multiple>
                        @foreach($servicepointdropdowns as $k => $v)
                        <option value="{{ $k }}" {{ in_array($k, old('servicepointdropdown', [])) ? 'selected' : '' }}>{{ $v }}</option>
                        @endforeach
                    </select>
