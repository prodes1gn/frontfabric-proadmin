    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">
                ...
                @endif
                {{ trans('cruds.blogitem') }}
                <small>{{ $task }}</small>
            </h3>
        </div>
    </div>
    <!--end::Header-->
    <form method="POST" action="{{ route("admin.blogitems.store") }}" enctype="multipart/form-data">
        @csrf
...
<div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                ...
                <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                    ...
                    <div class="input-group date">
                        <input class="form-control form-control-solid datepicker" readonly="readonly" type="text" name="date" value="{{ old('date', '') }}" placeholder="{{ trans('global.enter') }} {{ trans('cruds.date') }}">
                ...
                <div class="form-group {{ $errors->has('readtime') ? 'has-error' : '' }}">
                    ...
                    <input class="form-control form-control-solid maxlength" maxlength="255" type="text" name="readtime" value="{{ old('readtime', '') }}" placeholder="{{ trans('global.enter') }} {{ trans('cruds.readtime') }}">
