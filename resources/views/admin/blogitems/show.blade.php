...
<div class="card card-custom gutter-b">
        ...
        <div class="table-responsive table-striped table-hover">
            <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{ CMS::img($blogitem, 'seoimage', true) }}" height="100px;">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        @if(is_array($seotypes) && isset($seotypes[$blogitem->seotype]))
                        {{ $seotypes[$blogitem->seotype] }}
                        @else
                        -
                        @endif
                    </td>
    ...
    <div class="card-footer d-flex justify-content-between">
        <div class="form-group-show">
            <a class="btn btn-secondary font-weight-bold" href="{{ route('admin.blogitems.index') }}">
