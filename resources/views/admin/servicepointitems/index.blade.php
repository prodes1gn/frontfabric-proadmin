...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
        <h3 class="card-title align-items-start flex-column">
            ...
            <a href="{{ route('admin.servicepointitems.create') }}" class="btn btn-primary btn-icon font-weight-bold d-sm-none">
                <i class="fas fa-plus-circle"></i>
            </a>
            <a href="{{ route('admin.servicepointitems.create') }}" class="btn btn-primary font-weight-bold d-none d-sm-block">
                <i class="fas fa-plus-circle"></i>
                {{ trans('global.add') }}
            </a>
            @else
        ...
        <div class="card-toolbar">
            @include('admin.servicepointitems.submenu')
            <!--begin::Dropdown-->
            <div class="dropdown dropdown-inline mr-2">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <form action="{{ route('admin.servicepointitems.index') }}" method="GET">
                        <!--begin::Card-->
            ...
            <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if(auth()->user()->can('servicepointitem_show'))
                            <a href="{{ route('admin.servicepointitems.show', $row->id) }}" class="font-weight-bold btn btn-light-primary btn-hover-primary btn-sm text-left">
                        ...
                        <td class="font-weight-bold text-right">
                            <form action="{{ route('admin.servicepointitem.move', $row->id) }}" method="POST" style="display: inline-block;">
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ route('admin.servicepointitems.edit', $row->id) }}?lang={{ $locale }}" data-toggle="tooltip" data-theme="dark" title="{{ strtoupper($locale) }}" class="btn btn-icon btn-light btn-hover-secondary btn-sm">
                            ...
                            @endforeach                     
                            @else
                            <a href="{{ route('admin.servicepointitems.edit', $row->id) }}" data-toggle="tooltip" data-theme="dark" title="{{ trans('global.edit') }}" class="btn btn-icon btn-light btn-hover-warning btn-sm">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('admin.servicepointitems.destroy', $row->id) }}" class="float-left" method="POST">
