    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">
                ...
                @endif
                {{ trans('cruds.servicepointitem') }}
                <small>{{ $task }}</small>
            </h3>
        </div>
    </div>
    <!--end::Header-->
    <form method="POST" action="{{ route("admin.servicepointitems.store") }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card-body pb-5 row">
            <div class="col-lg-8">
                ...
                <div class="form-group {{ $errors->has('text') ? 'has-error' : '' }}">
                    ...
                    <input class="form-control form-control-solid maxlength" maxlength="255" type="text" name="text" value="{{ old('text', '') }}" placeholder="{{ trans('global.enter') }} {{ trans('cruds.text') }}">
                    @if($errors->has('text'))
                    <span class="help-block" role="alert">
