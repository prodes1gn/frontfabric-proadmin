...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">
                {{ trans('global.user') }}
                <small>{{ trans('global.create') }}</small>
            </h3>
        </div>
    </div>
    <!--end::Header-->
        ...
        <div class="card-body pb-5">
            ...
            <div class="form-group {{ $errors->has('avatar') ? 'has-error' : '' }}">
                ...
                <div class="image-input image-input-outline" id="kt_image_1">
                    <div class="image-input-wrapper" style="background-image: url({{ asset('uploads/settings/placeholder.png') }}); width: 200px;height: 200px;object-fit: cover;"></div>
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input class="form-control form-control-solid maxlength" maxlength="50" type="text" name="name" value="{{ old('name') }}" placeholder="{{ trans('global.enter') }} {{ trans('cruds.name') }}">
                @if($errors->has('name'))
            ...
            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                ...
                <input class="form-control form-control-solid maxlength" maxlength="150" type="email" name="email" value="{{ old('email') }}" placeholder="{{ trans('global.enter') }} {{ trans('global.email') }}">
                @if($errors->has('email'))
                <span class="help-block" role="alert">
            ...
            <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                <label for="password">{{ trans('global.password') }} <span class="required">*</span></label>
            ...
            <div class="form-group {{ $errors->has('approved') ? 'has-error' : '' }}">
                ...
                <div>
                    ...
                    <input data-switch="true" data-size="small" type="checkbox" data-on-color="success" data-on-text="{{ trans('global.yes') }}" data-off-color="danger" data-off-text="{{ trans('global.no') }}" name="approved" value="1" {{ old('approved', 0) == 1 ? 'checked' : '' }}>
                </div>
            ...
            <div class="form-group {{ $errors->has('verified') ? 'has-error' : '' }}">
                ...
                <div>
                    ...
                    <input data-switch="true" data-size="small" type="checkbox" data-on-color="success" data-on-text="{{ trans('global.yes') }}" data-off-color="danger" data-off-text="{{ trans('global.no') }}" name="verified" value="1" {{ old('verified', 0) == 1 ? 'checked' : '' }}>
                </div>
            ...
            <div class="form-group {{ $errors->has('roles') ? 'has-error' : '' }}">
                ...
                <select class="form-control select2 select2_multiselect" name="roles[]" multiple>
                    ...
                    <option value="{{ $role->id }}" {{ in_array($role->id, old('roles', [])) ? 'selected' : '' }}>{{ $role->translateOrDefault($lang)->title }}</option>
                    @endforeach
                </select>
                @if($errors->has('roles'))
                <span class="help-block" role="alert">
            ...
            <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                ...
                <div>
                    ...
                    <input data-switch="true" data-size="small" type="checkbox" data-on-color="success" data-on-text="{{ trans('global.yes') }}" data-off-color="danger" data-off-text="{{ trans('global.no') }}" name="status" value="1" {{ old('status', 0) == 1 ? 'checked' : '' }}>
                </div>
